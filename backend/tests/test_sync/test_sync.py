...
@patch("app.mail.mail_services.sync.import_emails")
@patch("app.mail.mail_services.sync.normalize_message")
@patch("app.mail.mail_services.sync.fetch_messages")
...
@patch("app.mail.mail_services.sync.fetch_outlook_messages")
...
@patch("app.mail.mail_services.sync.sync_provider")
